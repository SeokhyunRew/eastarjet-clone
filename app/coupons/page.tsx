  ...
  return (
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-2 md:space-x-4">
                ...
                <Button onClick={() => router.push("/")} variant="outline" size="sm" className="text-xs md:text-sm">
                  로그아웃
                </Button>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8">
          <div className="flex flex-col md:flex-row items-start md:items-center mb-4 md:mb-6 space-y-2 md:space-y-0">
            <Button
                onClick={() => router.push("/main")}
                variant="ghost"
                size="sm"
                className="text-gray-600 hover:text-gray-900 md:mr-4 self-start"
            >
              <ArrowLeft className="w-4 h-4 mr-2" />
              돌아가기
            </Button>
            <h1 className="text-xl md:text-2xl font-bold text-gray-900">내 쿠폰함</h1>
          </div>
                ...
                <div className="border-b">
                  <TabsList className="flex w-full bg-white h-auto p-0">
                    <TabsTrigger
                        ...
                        className={`flex-1 py-3 md:py-4 rounded-none border-b-2 text-xs md:text-sm ${
                        ...
                        {coupons.map((coupon, index) => (
                            ...
                            >
                              <div className="flex flex-col">
                                {/* Coupon Left Side */}
                                <div className="bg-gray-50 p-4 flex flex-row md:flex-col items-center justify-between md:justify-center md:w-1/4 border-b md:border-b-0 md:border-r">
                                  <div className="flex items-center md:flex-col">
                                    <div className="w-12 h-12 md:w-16 md:h-16 bg-red-100 rounded-full flex items-center justify-center mb-0 md:mb-2 mr-3 md:mr-0">
                                      {getCouponIcon(coupon.type)}
                                    </div>
                                    <div className="text-left md:text-center">
                                      <p className="text-xs md:text-sm text-gray-500">쿠폰 번호</p>
                                ...
                                <div className="p-4 md:w-3/4">
                                  <div className="flex flex-col md:flex-row justify-between items-start space-y-3 md:space-y-0">
                                    <div className="flex-1">
                                      <h3 className="text-base md:text-lg font-bold text-gray-900">{coupon.name}</h3>
                                      <p className="text-sm text-gray-600 mt-1">{coupon.description}</p>
                                    </div>
                                    <Button className="w-full md:w-auto bg-red-600 hover:bg-red-700 text-white text-sm">
                                      쿠폰 사용하기
                                    </Button>
                                  </div>

                                  <div className="mt-4 pt-4 border-t flex flex-col md:flex-row md:flex-wrap gap-2 md:gap-4 text-xs text-gray-500">
        ...
        {/* Footer */}
        <footer className="bg-gray-100 border-t mt-8 md:mt-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
            <div className="flex flex-col md:flex-row justify-between space-y-6 md:space-y-0">
              <div className="text-center md:text-left">
                <div className="text-red-600 text-lg md:text-xl font-bold mb-2 md:mb-4">EASTAR JET</div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 text-center md:text-left">
                <div>
                  <h3 className="text-xs md:text-sm font-medium text-gray-900 mb-2">이스타항공</h3>
                ...
                <div>
                  <h3 className="text-xs md:text-sm font-medium text-gray-900 mb-2">운항정보</h3>
                  <ul className="text-xs md:text-sm text-gray-600 space-y-1">
                    <li>스케줄 조회</li>
                    <li>취항지 정보</li>
                    <li>항공기 안내</li>
                ...
                <div>
                  <h3 className="text-xs md:text-sm font-medium text-gray-900 mb-2">항공권 예매</h3>
                  <ul className="text-xs md:text-sm text-gray-600 space-y-1">
                    <li>예매 안내</li>
                    <li>운임 안내</li>
                    <li>할인 제도</li>
                ...
                <div>
                  <h3 className="text-xs md:text-sm font-medium text-gray-900 mb-2">서비스 안내</h3>
                  <ul className="text-xs md:text-sm text-gray-600 space-y-1">
                    <li>공항 서비스</li>
                    <li>기내 서비스</li>
                    <li>부가 서비스</li>
            ...
            <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-xs text-gray-500 text-center md:text-left">© 2023 EASTAR JET. All rights reserved.</p>
